...
const Ribbons: React.FC<RibbonsProps> = ({
  ...
  useEffect(() => {
    ...
    // Attach listeners to window to track mouse even if container has pointer-events: none
  ...
  return <div ref={containerRef} className="ribbons-container" style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', zIndex: 9999, pointerEvents: 'none' }} />;
};
