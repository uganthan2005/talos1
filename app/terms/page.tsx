      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="border-b border-red-900/30 pb-8">
            <h1 className="text-3xl md:text-5xl text-red-600 mb-4 zen-dots-regular">TERMS & CONDITIONS</h1>
            <p className="text-sm md:text-base ibm-plex-mono-semibold text-gray-400">
              Last updated on 15-01-2026 17:08:27
            </p>
          </div>

          {/* Content */}
          <div className="space-y-6 text-sm md:text-base ibm-plex-mono text-gray-300 leading-relaxed text-justify">
            <p>
              These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding agreement by and between taloscit, ( “Website Owner” or “we” or “us” or “our”) and you (“you” or “your”) and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, “Services”).
            </p>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-4 marker:text-red-600">
              <li>
              ...
              <li>
                All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Chennai, Tamil Nadu
              </li>
              <li>
